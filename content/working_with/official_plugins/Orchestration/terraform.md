...
**Operations**
  ...
  * `terraform.tfsec`:   TFSec is a static analysis security scanner for your Terraform code. Here is an example of a yaml file that can be used to call a command.
