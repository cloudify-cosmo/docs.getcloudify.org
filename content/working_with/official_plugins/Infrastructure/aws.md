...
**Operations**
  ...
  * `cloudify.interfaces.lifecycle.configure`: Executes the [CreateStack](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_CreateStack.html) action.
    * `inputs`:
      * `minimum_wait_time`: Sets the minimum time in seconds that Cloudify will wait for the AWS will create the stack.
  ...
  * `inputs`:
      * `minimum_wait_time`: Sets the minimum time in seconds that Cloudify will wait for the AWS will delete the stack.
