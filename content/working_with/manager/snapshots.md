...
## Using the Web UI
Snapshot management is performed via the [System Resources]({{< relref "working_with/manager_webui/plugins-snapshots-page.md" >}}) page in the Web interface. You must have `admin` credentials to create and restore snapshots.
