...
* Try out the [local Hello World example]({{< relref "trial_getting_started/examples/fundamentals/" >}}) example using your new manager. No cloud credentials are required for this simple example.
