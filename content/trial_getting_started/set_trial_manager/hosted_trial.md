...
Check out your new {{< param cfy_manager_name >}} by installing the [Local Hello-World Example Deployment]({{< relref "trial_getting_started/examples/local/" >}}). This is a great way to become familiar with the basic concepts of the {{< param cfy_manager_name >}}.
