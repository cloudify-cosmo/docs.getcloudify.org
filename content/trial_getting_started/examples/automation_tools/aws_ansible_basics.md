...
This example demonstrates a simple infrastructure setup in **{{< param cloud_full >}} ({{< param cloud >}})** using an Ansible playbook, the deployment consists of:
...
+--------------------------+-------------------------------+-------------------------------+---------+--------------------------------------+------------+----------------+---------------------+-----------------------------+------------+
|  install-infra-playbook  | {{< param deployment_name >}} | {{< param deployment_name >}} |         |   cloudify.nodes.ansible.Executor    |   tenant   | default_tenant |          1          |              1              |   admin    |
| uninstall-infra-playbook | {{< param deployment_name >}} | {{< param deployment_name >}} |         |         cloudify.nodes.Root          |   tenant   | default_tenant |          1          |              1              |   admin    |
|      aws_infra_info      | {{< param deployment_name >}} | {{< param deployment_name >}} |         |         cloudify.nodes.Root          |   tenant   | default_tenant |          1          |              1              |   admin    |
