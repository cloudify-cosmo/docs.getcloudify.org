...
```bash
sudo yum install -y http://repository.cloudifysource.org/cloudify/cloudify-cluster-manager/1.0.12/ga-release/cloudify-cluster-manager-1.0.12-ga.el7.x86_64.rpm
```
