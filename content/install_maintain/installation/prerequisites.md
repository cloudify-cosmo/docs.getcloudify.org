...
You can also create a Cloudify Manager with the Amazon AWS and Openstack [images]({{< relref "install_maintain/installation/manager-image.md" >}}) available at [Cloudify downloads]( https://cloudify.co/download/ ).
