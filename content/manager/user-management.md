...
For more information on creating a user group, see either the [CLI command]({{< relref "cli/usergroups.md" >}}), or the [Cloudify Console.]({{< relref "manager_webui/tenant-management-page.md" >}})
...
So, userA is now assigned to dev_tenant twice – once as a Viewer and once as a User. Upon logging into this tenant, the permissions userA will have will be a sum of the permissions of the two roles. For more information regaring the user-roles, see [Managing Roles.]({{< relref "manager/roles-management.md" >}})
