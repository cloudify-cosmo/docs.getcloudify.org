...
During the bootstrap process, validations occur to verify minimum requirements. [Click here]({{< relref "installation/installing-manager.md" >}}#bootstrap-validations) for more information on bootstrap validations.
...
Next, you must [bootstrap]({{< relref "installation/installing-manager.md" >}}) a Cloudify Manager on the IaaS provider of your choice.
