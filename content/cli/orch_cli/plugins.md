...
{{< highlight  bash  >}}
$ cfy plugins upload http://repository.cloudifysource.org/cloudify/wagons/cloudify-openstack-plugin/2.9.0/cloudify_openstack_plugin-2.9.0-py27-none-linux_x86_64-centos-Core.wgn -y http://www.getcloudify.org/spec/openstack-plugin/2.9.0/plugin.yaml
...

Validating plugin cloudify_openstack_plugin-2.9.0-py27-none-linux_x86_64-centos-Core.wgn...
Plugin validated successfully
Uploading plugin cloudify_openstack_plugin-2.9.0-py27-none-linux_x86_64-centos-Core.wgn...
 cloudify_openstack_plug... |################################################| 100.0%
