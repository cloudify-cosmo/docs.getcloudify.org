...
The ``cfy workflows`` command is used to view information about the
different workflows of a deployment.

You can use the command to list the workflows of a specific deployment
and to retrieve information about a single workflow.
...
-  ``-d, --deployment-id TEXT`` - The ID of the deployment for which you
   want to list the executions.
...
``WORKFLOW_ID`` The ID of the workflow for which you want to get
information.
...
-  ``-d, --deployment-id TEXT`` - The ID of the deployment to which the
   workflow belongs.
